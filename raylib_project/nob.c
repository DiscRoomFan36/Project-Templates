...
bool build_wasm(void) {
    ...
    cmd_append(&cmd, "-o", BUILD_FOLDER"web/index.html");       // Output file, the .html extension determines the files that need to be generated: `.wasm`, `.js` (glue code) and `.html` (optional: `.data`). All files are already configured to just work.
